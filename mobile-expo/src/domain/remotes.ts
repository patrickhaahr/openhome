...
export const tvRemoteRows: ReadonlyArray<ReadonlyArray<RemoteCommand | null>> = [
  ...
  [
    { command: "channel-up", label: "Channel +" },
    { command: "guide", label: "Guide" },
    { command: "channel-down", label: "Channel -" },
  ],
  [
    { command: "home", label: "Home" },
    { command: "settings", label: "Settings" },
    { command: "info", label: "Info" },
  ],
  ...
  [
    { command: "hdmi-1", label: "HDMI 1" },
    { command: "hdmi-2", label: "HDMI 2" },
    { command: "hdmi-3", label: "HDMI 3" },
  ],
];
